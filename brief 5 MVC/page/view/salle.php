...
<body>
  ...
  <nav class="navbar navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand">Zelouani Dashboard</a>
      
      <form class="d-flex ">
        <a href="#" class="navbar-brand fs-6"><i class="material-icons fs-5">person</i>
          <?php echo $_SESSION['user'][0]['nom']." ". $_SESSION['user'][0]['prenom'] ?></a>
          <!-- <a href="http://localhost/www/brief%205%20MVC/page/login/deConnect" class="navbar-brand fs-6"><i
    ...
    <div class="sidebar col-md-3">
      <ul class="list-group">
        ...
        <li class=""><a class="list-group-item list-group-item-dark"
            ...
            <li>
              <a href="http://localhost/www/brief%205%20MVC/page/login/deConnect" class="btn btn-outline-danger singoutSide fixed-bottom mb-3" style="right: auto;"><i
            class="material-icons fs-5">logout</i> Sing out</a>
            </li>
      </ul>
    </div>
  ...
  function add() {
    ...
    if (Libelle != '' && capacite != '') {
      idForm.innerHTML += '<br><div class="d-flex"><div class="col-md-5"><input type="text" name="libelle'+ i +
        ...
        '" placeholder="Libelle"></div><div class="col-md-1"></div><div class="col-md-5"><input type="number" name="capacite'+i +'" value="' + capacite + '" class="form-control col-md-6" placeholder="capacite"></div></div>';
      i++;
    } else {
